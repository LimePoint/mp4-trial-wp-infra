...
password = PasswordVault.get_password(password_vault_name, 'obpsoa', 'keystorepass')
...
consoles = [
	...
	{
		"itemCode" => _item_code,
		"name" => "worklist_console",
		"description" => "Oracle Worklist",
		"url" => asset_vars['frontend']['protocol'] + '://' + asset_vars['frontend']['friendly_name'] + ":" + asset_vars['frontend']['friendly_port'] + "/integration/worklistapp"
	},
	{
		"itemCode" => _item_code,
		"name" => "bam_composer",
		"description" => "BAM Composer",
		"url" => asset_vars['frontend']['protocol'] + '://' + asset_vars['frontend']['friendly_name'] + ":" + asset_vars['frontend']['bam_port'] + "/bam/composer"
	}
]
