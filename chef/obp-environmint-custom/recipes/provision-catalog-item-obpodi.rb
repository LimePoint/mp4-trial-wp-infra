...
password = PasswordVault.get_password(password_vault_name, 'obpodi', 'keystorepass')
...
consoles = [
	...
	},
	{
		"itemCode" => _item_code,
		"name" => "odi_console",
		"description" => "Oracle Data Integrator Console",
		"url" => asset_vars['frontend']['protocol'] + '://' + asset_vars['frontend']['managed_host'] + ":" + asset_vars['frontend']['odi_port'] + "/odiconsole"
	}
]
