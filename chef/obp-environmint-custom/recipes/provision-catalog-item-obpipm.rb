...
password = PasswordVault.get_password(password_vault_name, 'obpipm', 'keystorepass')
...
consoles = [
	...
	},
	{
		"itemCode" => _item_code,
		"name" => "ipm",
		"description" => "Oracle Imaging Console",
		"url" => asset_vars['frontend']['protocol'] + '://' + asset_vars['frontend']['friendly_name'] + ":" + asset_vars['frontend']['friendly_port'] + "/imaging"
	},
	{
		"itemCode" => _item_code,
		"name" => "cs",
		"description" => "Oracle Content Server",
		"url" => asset_vars['frontend']['protocol'] + '://' + asset_vars['frontend']['friendly_name'] + ":" + asset_vars['frontend']['friendly_port'] + "/cs"
	}
]
