...
template "Processing obpcim-create-rstrc-admin-user.sql" do
	source "sql/obpcim-create-rstrc-admin-user.sql.erb"
	path "#{base_dir}/obpcim-create-rstrc-admin-user.sql"
	mode '0644'
	user 'oracle'
	group 'oinstall'
end

oracle_sql "#{base_dir}/obpcim-create-rstrc-admin-user.sql" do
	...
	as_sysdba false
	sql_file "#{base_dir}/obpcim-create-rstrc-admin-user.sql"
	action :run
	user 'oracle'
	group 'oinstall'
end
