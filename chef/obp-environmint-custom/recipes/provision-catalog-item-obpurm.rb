...
password = PasswordVault.get_password(password_vault_name, 'obpurm', 'keystorepass')
...
consoles = [
	...
	},
	{
		"itemCode" => _item_code,
		"name" => "urm",
		"description" => "Oracle URM Server",
		"url" => asset_vars['frontend']['protocol'] + '://' + asset_vars['frontend']['friendly_name'] + ":" + asset_vars['frontend']['friendly_port'] + "/urm"
	}
]
