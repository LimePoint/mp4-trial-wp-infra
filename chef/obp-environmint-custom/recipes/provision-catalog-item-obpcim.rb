...
password = PasswordVault.get_password(password_vault_name, 'obpcim', 'keystorepass')
...
consoles = [
	...
	{
		"itemCode" => _item_code,
		"name" => "sysadmin_console",
		"description" => "Oracle OIM Sysadmin Console",
		"url" => asset_vars['frontend']['protocol'] + '://' + asset_vars['frontend']['otd_vip_name'] + "/sysadmin"
	},
	{
		"itemCode" => _item_code,
		"name" => "identity_console",
		"description" => "Oracle OIM Identity Console",
		"url" => asset_vars['frontend']['protocol'] + '://' + asset_vars['frontend']['otd_vip_name'] + "/identity"
	}
