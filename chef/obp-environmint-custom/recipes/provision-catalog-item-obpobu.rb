...
password = PasswordVault.get_password(password_vault_name, 'obpobu', 'keystorepass')
...
consoles = [
	...
	},
	{
		"itemCode" => _item_code,
		"name" => "em_console",
		"description" => "Oracle Banker Login",
		"url" => asset_vars['frontend']['protocol'] + '://' + asset_vars['frontend']['friendly_name'] + ":" + asset_vars['frontend']['friendly_port'] + "/com.ofss.fc.ui.view/faces/main.jspx"
	}
]
