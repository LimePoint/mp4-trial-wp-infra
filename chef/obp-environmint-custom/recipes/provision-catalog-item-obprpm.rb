...
password = PasswordVault.get_password(password_vault_name, 'obposb', 'keystorepass')
...
mintpress_resource "coherence-config" do
	...
	value "%LISTENNAME%#{asset_vars['dns_domain_name']}"
end
...
consoles = [
	...
	{
		"itemCode" => _item_code,
		"name" => "bpmworkspace_console",
		"description" => "Oracle BPM Workspace",
		"url" => asset_vars['frontend']['protocol'] + '://' + asset_vars['frontend']['rpm_host'] + ":" + asset_vars['frontend']['rpm_host'] + "/bpm/workspace"
	},
	{
		"itemCode" => _item_code,
		"name" => "bpmcomposer_console",
		"description" => "Oracle BPM Composer",
		"url" => asset_vars['frontend']['protocol'] + '://' + asset_vars['frontend']['rpm_host'] + ":" + asset_vars['frontend']['rpm_port'] + "/bpm/composer"
	}
]
