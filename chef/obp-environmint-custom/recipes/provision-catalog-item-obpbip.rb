...
password = PasswordVault.get_password(password_vault_name, 'obpbip', 'keystorepass')
...
consoles = [
	...
	},
	{
		...
		"url" => asset_vars['frontend']['protocol'] + '://' + asset_vars['frontend']['friendly_name'] + ":" + asset_vars['frontend']['friendly_port'] + "/analytics"
	},
	{
		"itemCode" => _item_code,
		"name" => "xmlpserver",
		"description" => "Oracle BI Publisher Enterprise",
		"url" => asset_vars['frontend']['protocol'] + '://' + asset_vars['frontend']['friendly_name'] + ":" + asset_vars['frontend']['friendly_port'] + "/xmlpserver"
	}
]
