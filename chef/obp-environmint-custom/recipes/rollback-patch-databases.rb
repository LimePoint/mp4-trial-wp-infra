# Author        : Uday Bulusu
# Description   : Recipe to rollback a given patch (#{patch2rollback}) that was previously applied.
#
...
if is_running_on_cloud
    ...
    patch2rollback = db_version == '12.1.0.2' ? 'p29158680_12102171017ProactiveBP_Linux-x86-64' : 'p29158680_12201181016DBOCT2018RU_Linux-x86-64'
    ...
    oracle_patch "p29158680-for-JSON-TAB-QUERY" do
      ...
      shutdown_instances false
      action :rollback
      notifies :rollback, 'oracle_patch[prereq-for-p29158680]', :immediately
    end
    ...
    oracle_listener 'start-listener' do
      ...
      action :start
      notifies :startup, 'ruby_block[startup-db-services]', :before
    end
end
