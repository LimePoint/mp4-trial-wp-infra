...
consoles = [
	...
	},
	{
		"itemCode" => _item_code,
		"name" => "odsm_console",
		"description" => "Oracle Directory Services Manager Console",
		"url" => asset_vars['frontend']['protocol'] + '://' + asset_vars['frontend']['admin_host'] + ":" + asset_vars['frontend']['admin_port'] + "/odsm"
	}
]
