...
password = PasswordVault.get_password(password_vault_name, 'obpoam', 'keystorepass')
...
consoles = [
	...
	},
	{
		"itemCode" => _item_code,
		"name" => "oam_console",
		"description" => "Oracle OAM Admin Console",
		"url" => asset_vars['frontend']['protocol'] + '://' + asset_vars['frontend']['admin_host'] + ":" + asset_vars['frontend']['admin_port'] + "/oamconsole"
	}
